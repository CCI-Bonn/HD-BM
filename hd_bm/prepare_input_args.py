...
from hd_bm.paths import folder_with_hd_bm_parameter_files, folder_with_hd_bm_slim_parameter_files
...
def prepare_input_args_hd_bm(input_dir, input_id, output_dir, output_id, skip_modality_confirmation):
    plans_file = file_io.load_pickle(os.path.join(folder_with_hd_bm_parameter_files, "plans.pkl"))
...
def prepare_input_args_hd_bm_slim(input_dir, input_id, output_dir, output_id, skip_modality_confirmation):
    plans_file = file_io.load_pickle(os.path.join(folder_with_hd_bm_slim_parameter_files, "plans.pkl"))
    modalities = plans_file["modalities"]
    print_expected_modalities(modalities)
